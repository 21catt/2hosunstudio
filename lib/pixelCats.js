...
export const PIXEL_CATS = [
  ...
  // 우주 헬멧 시리즈(2달 무료→작물 교환) — 파일(public/pixel-cats/19~23-space-*.png) 들어오면 아래 주석 해제로 활성화
  // '19-space-blue', '20-space-bear', '21-space-fox', '22-space-pink', '23-space-galaxy',
  STUDIO_CAT,
]
...
export const CAT_UNLOCKS = {
  ...
  '19-space-blue':   { freeUntil: '2026-09-24', harvest: 10 },
  '20-space-bear':   { freeUntil: '2026-09-24', harvest: 12 },
  '21-space-fox':    { freeUntil: '2026-09-24', harvest: 14 },
  '22-space-pink':   { freeUntil: '2026-09-24', harvest: 16 },
  '23-space-galaxy': { freeUntil: '2026-09-24', harvest: 20 }, // 갤럭시 바이저 = 프레스티지
