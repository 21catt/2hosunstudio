...
// 기초 드로잉(BASIC DRAWING) 문서 — 시선이 흐르는 7개 개념. 편집기 샘플.
export const BASIC_DRAWING_CORE_DOC = {
  theme: 'terra',
  hero: {
    eyebrow: 'BASIC DRAWING · 기초 드로잉 과정',
    title: '보는 법부터,',
    titleAccent: ' 그리는 법까지',
    desc: '똑같이 옮겨 그리는 기술이 아니라, 자신의 창작에 쓸 수 있는 조형적 사고와 시선을 기르는 수업입니다. 처음이어도 괜찮습니다.',
    image: '',
  },
  meta: [
    { k: '일정', v: '주 1회 · 120분' },
    { k: '모집', v: '상시 모집 — 원하는 날짜부터 시작' },
    { k: '예약', v: '원하는 일정을 앱으로 예약해 참여' },
    { k: '대상', v: '처음이어도 괜찮은 입문 과정' },
  ],
  statement: {
    eyebrow: '원리 · 이론 · 실습',
    title: '누구나 거치는 핵심 개념을, 원리로 익힌다.',
    desc: '그림을 그리는 사람이라면 누구나 거치는 개념을, 원리와 이론을 바탕으로 직접 실습한다. 모사를 넘어 자신의 창작으로.',
  },
  sections: {
    approaches: { eyebrow: '세 단계', title: '무엇을 다루나' },
    chips:      { eyebrow: '일곱 걸음', title: '시선이 흐르는' },
    outcomes:   { eyebrow: '과정을 마치면', title: '이런 것들을 할 수 있어요' },
  },
  approaches: [
    { num: '01', title: '선과 형태', en: 'LINE & FORM', desc: '선 긋는 법에서 도형으로 형태 읽기까지. 무엇이든 그릴 수 있는 기초를 세운다.', image: '' },
    { num: '02', title: '흐름과 구조', en: 'RHYTHM & STRUCTURE', desc: '리듬으로 자연스러움을, 구조선으로 보이지 않는 뼈대를 세운다.', image: '' },
    { num: '03', title: '조형과 표현', en: 'COMPOSITION & EXPRESSION', desc: '조형 원리·입체·공간을 거쳐, 선에 감정을 싣는 자신의 시선으로.', image: '' },
  ],
  chips: ['선', '면', '리듬', '구조', '조형', '입체·공간', '감정'],
  modules: [
    { num: '01', cat: '① 선과 형태', title: '선', en: 'LINE',
      desc: '선은 과정이자 결과입니다. 면보다 함축적이고 점보다 설명적이죠. 선 긋는 법에서 시작해, 선에 무게를 싣는 법까지.',
      painters: [], bullets: ['테이퍼 라인', '강약·속도', '손목·팔', '선의 가중치'], image: '' },
    { num: '02', cat: '① 선과 형태', title: '면과 형태', en: 'PLANE & FORM',
      desc: '복잡한 대상을 도형으로 읽기. 큰 덩어리부터. 평면 도형으로 형태에 접근하면 무엇이든 그릴 길이 생깁니다.',
      painters: [], bullets: ['도형화', '형태 접근', '비례'], image: '' },
    { num: '03', cat: '② 흐름과 구조', title: '리듬', en: 'RHYTHM',
      desc: '선과 형태에 흐름을 주기. 속도가 리듬을 만들고, 리듬이 자연스러움을 만듭니다. 빈 드로잉으로 흐름을 먼저 잡습니다.',
      painters: [], bullets: ['빈 드로잉', '리듬감', '제스처'], image: '' },
    { num: '04', cat: '② 흐름과 구조', title: '구조선', en: 'STRUCTURE LINE',
      desc: '보이지 않는 뼈대를 세우기. 대상 안에 숨은 축과 구조를 먼저 읽습니다. 보이는 표면은 그다음입니다.',
      painters: [], bullets: ['구조선의 종류', '중심축', '구조 분석'], image: '' },
    { num: '05', cat: '③ 조형과 표현', title: '조형 원리', en: 'COMPOSITION',
      desc: '화면을 구성하는 언어. 면과 선이 화면 위에서 어떻게 관계 맺는지. 모사를 넘어 창작으로 가는 지점입니다.',
      painters: [], bullets: ['면 조형', '선 조형', '기초 구성요소'], image: '' },
    { num: '06', cat: '③ 조형과 표현', title: '입체와 공간', en: 'FORM & SPACE',
      desc: '평면 위에 깊이를 세우기. 각도에 따라 형이 어떻게 변하는지 읽고, 쉬운 원근 규칙으로 거리를 만듭니다.',
      painters: [], bullets: ['입체 도형 분석', '각도', '원근'], image: '' },
    { num: '07', cat: '③ 조형과 표현', title: '선과 감정', en: 'LINE & EMOTION',
      desc: '선이 표현이 되는 자리. 같은 선도 감정을 싣습니다. 마지막엔 추상으로, 자신의 시선을 선에 담습니다.',
      painters: [], bullets: ['감정과 선', '선의 분석', '추상 드로잉'], image: '' },
  ],
  outcomes: [
    { title: '무엇이든 그릴 수 있어요', desc: '눈앞의 대상을 관찰하고, 단순한 형태로 분해해 종이 위에 자신 있게 옮깁니다.' },
    { title: '입체를 세울 수 있어요', desc: '각도와 구조를 읽어, 평면 위에 무게와 깊이를 만들어냅니다.' },
    { title: '자신만의 드로잉을 할 수 있어요', desc: '질감과 공간감을 더해, 나만의 스타일이 담긴 창작을 하실 수 있습니다.' },
  ],
  cta: {
    title: '재능이 아니라 관찰과 반복으로\n자라는 감각입니다.',
    desc: '그 첫 흐름을 함께 걸어갑니다. 입문 · 누구나 · 핵심 개념 흐름 · 관찰에서 창작까지.',
    buttonText: '자세히 알아보기',
    image: '',
  },
}
...
// 인물 두상 조소(SCULPTURE · HEAD) 문서 — 덩어리에서 표현으로 흐르는 4단계. 편집기 샘플.
export const SCULPTURE_HEAD_CORE_DOC = {
  theme: 'terra',
  hero: {
    eyebrow: 'SCULPTURE · 인물 두상',
    title: '복잡한 얼굴도,',
    titleAccent: ' 덩어리에서 시작한다.',
    desc: '복잡한 인물 두상을 단순한 기본 도형에서부터 시작해, 단계별로 차근차근 완성해 보는 실기 수업입니다.',
    image: '',
  },
  meta: [
    { k: '일정', v: '주 1회 · 120분' },
    { k: '모집', v: '상시 — 원하는 날부터' },
    { k: '예약', v: '앱으로 일정 선택' },
    { k: '대상', v: '두상 조소를 처음 다루는 분' },
  ],
  statement: {
    eyebrow: '구조에서 표현까지',
    title: '형태는 세우고 나서 다듬는다.',
    desc: '뼈대로 구조를 먼저 세우고 그 위에 이목구비와 살을 올린다. 질감과 마무리는 맨 뒤다. 순서를 지키면 복잡한 얼굴도 다룰 수 있는 단계로 나뉜다.',
  },
  sections: {
    approaches: { eyebrow: '세 가지 접근', title: '무엇을 다루나' },
    chips:      { eyebrow: '네 단계', title: '덩어리에서 표현으로' },
    outcomes:   { eyebrow: '과정을 마치면', title: '이런 것들을 할 수 있다' },
  },
  approaches: [
    { num: '01', title: '기초 조형의 이해', en: 'STRUCTURE & MASS',
      desc: '조각 내부 구조를 이해하고, 두상을 단순한 도형으로 환원해 크게 보는 연습을 한다.', image: '' },
    { num: '02', title: '흐름과 형태', en: 'RHYTHM & FORM',
      desc: '리듬을 읽는다. 형태는 다양한 각도에서 관찰하는 힘이 필요하다.', image: '' },
    { num: '03', title: '입체적 표현', en: 'PLANES & VOLUME',
      desc: '면의 입체적 변화를 이해하며 조형을 연구한다. 면을 어떻게 다룰지, 양감과 면의 방향을 연구한다.', image: '' },
  ],
  chips: ['덩어리', '뼈대', '이목구비', '조각적 표현'],
  modules: [
    { num: '01', cat: '덩어리', title: '모듈 1 — 덩어리, 형태', en: 'MASS & FORM',
      desc: '기본양을 만든다. 기본 심재를 붙이고 두상의 기본이 되는 형태를 세운 뒤, 덩어리를 단순한 도형으로 보며 크게 보는 연습을 한다.',
      painters: [], bullets: ['기본 심재 붙이기', '기본양 만들기', '단순한 도형으로 크게 보기'], image: '' },
    { num: '02', cat: '뼈대', title: '모듈 2 — 뼈대', en: 'SKELETON',
      desc: '골격을 만든다. 기본양에서 뼈대가 되는 부분을 찾아 세운다.',
      painters: [], bullets: ['두개골', '광대', '턱', '코', '이마'], image: '' },
    { num: '03', cat: '이목구비', title: '모듈 3 — 이목구비, 지방, 근육', en: 'FEATURES & MUSCLE',
      desc: '두상의 각 요소를 배워 나간다. 이를 조화롭게 구성해 객체 간의 비례와 위치를 이해한다.',
      painters: [], bullets: ['이목구비', '지방', '근육', '비례와 위치'], image: '' },
    { num: '04', cat: '조각적 표현', title: '모듈 4 — 조각적 표현', en: 'TEXTURE & FINISH',
      desc: '손과 도구를 통해 질감, 표현, 완성도를 연구한다.',
      painters: [], bullets: ['손과 도구', '질감', '표현', '완성도'], image: '' },
  ],
  outcomes: [
    { title: '복잡한 얼굴을 도형으로 환원한다', desc: '세부부터 손대지 않는다. 큰 덩어리를 먼저 세우고 좁혀 들어간다.' },
    { title: '구조 위에 형태를 올린다', desc: '두개골·광대·턱을 기준으로 잡아 두면 이목구비의 자리가 흔들리지 않는다.' },
    { title: '여러 각도에서 형태를 읽는다', desc: '한 방향에서만 맞는 형태는 조각에서 맞는 형태가 아니다.' },
    { title: '면과 양감으로 마무리한다', desc: '면의 방향을 정하고, 손과 도구로 질감과 완성도까지 끌고 간다.' },
  ],
  cta: {
    title: '덩어리에서 시작해,\n표현에서 끝난다.',
    desc: '주 1회 · 120분 · 상시 모집. 두상 조소가 처음이어도 단계대로 따라올 수 있습니다.',
    buttonText: '자세히 알아보기',
    image: '',
  },
}
...
export const CORE_DOC_SAMPLES = [
  ...
  { key: 'drawing',  label: '기초 드로잉 샘플', doc: BASIC_DRAWING_CORE_DOC },
  { key: 'sculpture', label: '조소 두상 샘플', doc: SCULPTURE_HEAD_CORE_DOC },
]
